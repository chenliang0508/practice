...
public class WXpayQrPayHandle extends DefaultQrPayHandle {
	...
	public ModelAndView preToOrder(TpCulCommerical culCommInfo) {
		...
		String data= new StringBuffer().append("service=unified.qrcode.toOrder").append("&mchId=").append(culCommInfo.getCulCommNo())
		...
		try {
			...
			//uri = new StringBuffer().append("https://www.chinagiftcard.cn/mpayms/mvpay/toGateWay").toString();
