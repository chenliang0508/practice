...
public class ChannelResponseInfo {
	...
	public String toString() {
		return "ChannelResponseInfo [code=" + code + ", msg=" + msg + ", responseResult=" + responseResult + ", tradeStatus=" + tradeStatus + ", thirdPaymentTxnid="
				+ thirdPaymentTxnid + ", channelTxnNo=" + channelTxnNo + ", tradeNo=" + tradeNo + ", authCodeUrl=" + authCodeUrl + ", authCodeImgUrl=" + authCodeImgUrl
				+ ", totalFee=" + totalFee + ", discountFee=" + discountFee + ", tradeEndDate=" + tradeEndDate + ", tradeEndTime=" + tradeEndTime + ", subIsSubscribe="
				+ subIsSubscribe + ", appid=" + appid + ", subAppid=" + subAppid + ", subOpenId=" + subOpenId + ", isSubscribe=" + isSubscribe + ", needQuery=" + needQuery
				+ ", payInfo=" + payInfo + ", payUrl=" + payUrl + ", couponFee=" + couponFee + ", refundNo=" + refundNo + ", refundId=" + refundId + ", refundFee=" + refundFee
				+ ", refundChannel=" + refundChannel + ", couponRefundFee=" + couponRefundFee + ", discountRefundFee=" + discountRefundFee + ", refundCount=" + refundCount
				+ ", refundReason=" + refundReason + ", refundDate=" + refundDate + ", refundTime=" + refundTime + ", mchId=" + mchId + ", deviceInfo=" + deviceInfo
				+ ", tradeType=" + tradeType + ", feeType=" + feeType + ", attach=" + attach + ", bankType=" + bankType + ", bankBillNo=" + bankBillNo + ", payResult=" + payResult
				+ ", thirdBuyerAccount=" + thirdBuyerAccount + ", thirdSellerAccount=" + thirdSellerAccount + ", discountInfo=" + discountInfo + ", tokenId=" + tokenId
				+ ", IsvOrgId=" + IsvOrgId + ", orderType=" + orderType + ", channelType=" + channelType + ", buyerPayAmount=" + buyerPayAmount + ", receiptAmount=" + receiptAmount
