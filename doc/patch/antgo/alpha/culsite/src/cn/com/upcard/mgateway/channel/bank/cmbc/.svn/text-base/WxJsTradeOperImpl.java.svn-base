...
public class WxJsTradeOperImpl extends AbstractUnifiedOper{
	...
	public ChannelResponseInfo pay(ChannelRequestInfo channelRequestInfo) {
		...
		map.put("selectTradeType", CMBCPayType.H5_WXJSAPI.name());
		...
		map.put("subAppId", channelRequestInfo.getSubAppid());
		map.put("subOpenId", channelRequestInfo.getSubOpenid());
