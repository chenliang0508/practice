...
public class AliDirectTradeOperImpl extends AbstractUnifiedOper {
	private static Logger logger = LoggerFactory.getLogger(AliDirectTradeOperImpl.class);
	...
	public ChannelResponseInfo pay(ChannelRequestInfo channelRequestInfo) {
		...
		map.put("selectTradeType", CMBCPayType.API_ZFBSCAN.name());
