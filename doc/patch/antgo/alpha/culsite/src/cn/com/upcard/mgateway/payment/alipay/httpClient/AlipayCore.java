...
public class AlipayCore {
    ...
    public static String createLinkString(Map<String, String> params) {
        ...
        String prestr = "";
//        System.out.println("ali url value");
...
//    	 prestr = prestr.substring(0,prestr.length()-1);
    	 ...
    	 prestr.append("service="+params.get("service")+"&");
    	 prestr.append("v="+params.get("v")+"&");
    	 prestr.append("sec_id="+params.get("sec_id")+"&");
    	 prestr.append("notify_data="+params.get("notify_data"));
