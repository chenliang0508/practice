...
<link rel="stylesheet" type="text/css"
	href="<%=basePath%>css/qr/qr-weixin.css" />
<title>付款</title>
...
<body>
	...
	<div class="pay-box">
		<div class="pay-top">
			<span class="pay-top01"><img
				src="<%=basePath%>images/qr/weixin-qr/logo-wx.png" /></span>
	...
	<div class="keyboardbox">
		<div>
			...
			<span class="key-board" data-num="10"
				...
				src="<%=basePath%>images/qr/weixin-qr/del.png"
			...
			<span id="keybosure"
				style="color: white; background-color: #bae0ba; height: 10.5rem; bottom: 0; right: 0; width: 28%; line-height: 1.75rem; font-size: 20px;"><a
				style="display: block; margin-top: 3.5rem;">确认<br />支付
			</a></span> <span class="key-board" data-num="7"
	...
	<form id="myform"
		...
		<input type="hidden" name="timestamp" value="${timestamp}" /> <input
			...
			name="sign" value="${sign}" /> <input type="hidden"
			name="thirdBuyerId" value="${thirdBuyerId}" /> <input type="hidden"
			id="totalAmount" name="totalAmount" value="" /> <input type="hidden"
			name="reqIp" value="127.0.0.1" /> <input type="hidden" name="body"
			value="银商静态二维码" />
	</form>
</body>
</html>